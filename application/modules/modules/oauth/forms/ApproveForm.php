...
class Oauth_Form_ApproveForm extends Zend_Form {
    ...
    public function buildRsetDisclaimer($rsets, Oauth_Model_Client $client){
	        ...
	        foreach ($rsets as $r) {
	            $rset_desc[] = sprintf("<li>%s</li>", $r->getName());
	        }

	        $rset_desc = implode("", $rset_desc);
	        $description = sprintf($disclaimer, $client->getName(), $rset_desc);
