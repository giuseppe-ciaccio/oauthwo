 ...
 * @author Antonio Pastorino <antonio.pastorino@gmail.com>
 */
class Oauth_Model_RefreshTokenWRS{
 ...
 /**
     ...
     * @return Oauth_Model_AuthorizationCodeWRS
     */
    ...
    /**
	     * Sets the granted rsets
	     *
	     * @param string $scopes
	     * @return Oauth_Model_AuthorizationCodeWRS
	     */
	    public function setRSets($rsets) {
	        $this->_rsets = (string) $rsets;
	        return $this;
	    }

	    /**
	     * Return the rsets this code will grants
	     *
	     * @return string
	     */
	    public function getRSets() {
	        return $this->_rsets;
    }
